  ...
  return (
    <section className="relative bg-[url(https://www.brookings.edu/wp-content/uploads/2022/06/2015-05-13T120000Z_1913900413_GF10000093469_RTRMADP_3_AFRICA-CROPS.jpg)] bg-cover bg-center bg-no-repeat ">
      ...
      <div className="relative mx-auto w-screen px-4 py-32  h-screen justify-center    flex flex-row ">
        ...
        <h1 className="text-white text-4xl md:text-6xl font-bold max-w-[900px] text-center">Green world & Food Security Solutions</h1>
        <p className="text-white max-w-[900px] md:text-lg tracking-wide text-center"><b>One of the sustainable approaches to food security is sustainable agricultural practices. Zero hunger is possible!</b></p>

            <div className="flex md:flex-row flex-col md:space-x-8 space-y-10 md:space-y-0 md:justify-center justify-between ">
            <Link to='/signup'>
             <button className='hover:animate-pulse md:min-w-[250px] w-[100%] bg-[#4DB852] text-white tracking-wide  md:py-4 py-3 md:px-16  md:text-md text-[14px] uppercase hover:bg-[#A8CF45] rounded-3xl'>Discover More</button>
            </Link>
           
           <Link to='login'>
             <button className='md:min-w-[250px] min-w-[100%] bg-[white] text-[#4DB852] tracking-wide md:py-4 py-3 md:px-16  md:text-md text-[14px] uppercase rounded-3xl'>Login</button>
           </Link>
            </div>
        </div>
